...
function draw(draw_state)
     local component = bit.rshift(draw_state, 5)

     prepare()

     if (component == 0) then
          box_frame(bit.band(draw_state, 31))
     elseif (component == 1) then
          disc_circle(bit.band(draw_state, 31))
     elseif (component == 2) then
          r_frame(bit.band(draw_state, 31))
     elseif (component == 3) then
          stringtest(bit.band(draw_state, 31))
     elseif (component == 4) then
          line(bit.band(draw_state, 31))
     elseif (component == 5) then
          triangle(bit.band(draw_state, 31))
     elseif (component == 6) then
          ascii_1()
     elseif (component == 7) then
          extra_page(bit.band(draw_state, 31))
     end
end
